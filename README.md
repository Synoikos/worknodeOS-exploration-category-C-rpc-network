# Category C: RPC ${CATEGORY_NAME} Network
...
Analyze all 7 documents in \`source-docs/\` and produce:
...
Create \`analysis/CATEGORY_C_ANALYSIS.md\` following the structure in AGENT_ARCHITECTURE_BOOTSTRAP.md
