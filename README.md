# Category C: RPC CATNAME Network
...
Create `analysis/CATEGORY_C_ANALYSIS.md` with this structure:
...
Create `analysis/CATEGORY_C_RESEARCH_QUESTIONS.md` with 30-50 questions.
...
```bash
git add analysis/
git commit -m "Category C Wave 1 analysis complete"
git push
```
...
- [ ] analysis/CATEGORY_C_ANALYSIS.md created
...
- [ ] analysis/CATEGORY_C_RESEARCH_QUESTIONS.md created
